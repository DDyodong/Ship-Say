...
export const ui: Record<string, UiText> = {
  ko: {
    ...
    unsupported: "모델 미지원 장비", manualChecks: ["안전화 착용 상태를 확인했습니다.", "안전복 착용 상태를 확인했습니다."],
  ...
  en: {
    ...
    unsupported: "Equipment not covered by the model", manualChecks: ["I checked that safety shoes are worn.", "I checked that safety workwear is worn."],
  ...
  vi: {
    ...
    unsupported: "Thiết bị mô hình chưa hỗ trợ", manualChecks: ["Tôi đã kiểm tra giày bảo hộ.", "Tôi đã kiểm tra quần áo bảo hộ."],
  ...
  zh: {
    ...
    unsupported: "模型不支持的装备", manualChecks: ["已确认穿着安全鞋。", "已确认穿着安全工作服。"],
  ...
  id: {
    ...
    unsupported: "Peralatan yang belum didukung model", manualChecks: ["Saya memastikan sepatu keselamatan dipakai.", "Saya memastikan pakaian keselamatan dipakai."],
  ...
  fil: {
    ...
    unsupported: "Hindi suportadong kagamitan", manualChecks: ["Tiniyak kong suot ang safety shoes.", "Tiniyak kong suot ang safety workwear."],
  ...
  ne: {
    ...
    unsupported: "मोडेलले नसमेटेका उपकरण", manualChecks: ["सुरक्षा जुत्ता लगाएको जाँचें।", "सुरक्षा पोसाक लगाएको जाँचें।"],
  ...
  uz: {
    ...
    unsupported: "Model qo‘llamaydigan jihozlar", manualChecks: ["Xavfsizlik poyabzali kiyilganini tekshirdim.", "Xavfsizlik ish kiyimi kiyilganini tekshirdim."],
  ...
  si: {
    ...
    unsupported: "ආකෘතිය සහාය නොදක්වන උපකරණ", manualChecks: ["ආරක්ෂක පාවහන් පැළඳ ඇති බව පරීක්ෂා කළෙමි.", "ආරක්ෂක වැඩ ඇඳුම පැළඳ ඇති බව පරීක්ෂා කළෙමි."],
  ...
  ta: {
    ...
    unsupported: "மாதிரி ஆதரிக்காத உபகரணங்கள்", manualChecks: ["பாதுகாப்புக் காலணிகள் அணிந்ததைச் சரிபார்த்தேன்.", "பாதுகாப்பு வேலை உடை அணிந்ததைச் சரிபார்த்தேன்."],
  ...
  th: {
    ...
    unsupported: "อุปกรณ์ที่โมเดลยังไม่รองรับ", manualChecks: ["ตรวจแล้วว่าสวมรองเท้านิรภัย", "ตรวจแล้วว่าสวมชุดนิรภัย"],
  ...
  my: {
    ...
    unsupported: "မော်ဒယ် မထောက်ပံ့သောပစ္စည်း", manualChecks: ["ဘေးကင်းရေးဖိနပ် ဝတ်ထားကြောင်း စစ်ဆေးပြီး။", "ဘေးကင်းရေးအလုပ်ဝတ်စုံ ဝတ်ထားကြောင်း စစ်ဆေးပြီး။"],
